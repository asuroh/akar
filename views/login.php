...
<html lang="en">
  <head>
    ...
    <meta name="title" content="AdminLte | Login Page" />
    ...
    <!--begin::Required Plugin(Akar)-->
    <link rel="stylesheet" href="../asset/dist/css/adminlte.css" />
    <!--end::Required Plugin(Akar)-->
  </head>
  <!--end::Head-->
  <!--begin::Body-->
  <body class="login-page bg-body-secondary">
    <main class="login-box">
      <h1 class="login-logo">
        <a href="../index2.html"><b>Akar {Aplikasi Karyawan}</b></a>
      </h1>
      <!-- /.login-logo -->
      <div class="card">
        <div class="card-body login-card-body">
          ...
          <form action="../controller/auth_proses.php" method="post">
            <label class="visually-hidden" for="loginUsername">Username</label>
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
    <!--end::Required Plugin(Bootstrap 5)--><!--begin::Required Plugin(Akar)-->
    ...
    <!-- The light/dark/auto switcher ships in Akar.js as the ColorMode
